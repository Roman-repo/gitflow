...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ПараметрыДерева") Тогда
		...
		Если ПараметрыДерева.Свойство("ОбъектКопирования") Тогда
			...
			ЗаполнитьЗначенияСвойств(Объект, ОбъектКопирования,"Владелец, Наименование, ПространствоИмен, ПространствоИменБазовогоТипа");
	...
	Если БазовыйТипВариант = 2 И ЗначениеЗаполнено(Объект.БазовыйТип) Тогда
		КонвертацияДанныхXDTOСервер.РазложитьПредставлениеПростогоТипа(НРег(Объект.БазовыйТип),Ложь, ТипБазовогоТипа, ДлинаБазовогоТипа, ТочностьБазовогоТипа, МинимальнаяДлинаСтроки, НеограниченнаяДлина);
	КонецЕсли;
КонецПроцедуры
