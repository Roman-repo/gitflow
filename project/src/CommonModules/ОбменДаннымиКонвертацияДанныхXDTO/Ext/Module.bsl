...
Функция ОпределитьПараметрыЗапросаОбъекта(ЭлементДанных, ТипЗначенияОбъекта = Неопределено) Экспорт
	...
	Если ТипЗначенияОбъекта = Тип("СправочникОбъект.Алгоритмы")
		...
		Или ТипЗначенияОбъекта = Тип("СправочникОбъект.ПравилаОбработкиДанных")
		Или ТипЗначенияОбъекта = Тип("СправочникОбъект.Запросы") Тогда
		// Привязка через справочник "СоставыКонвертаций".
		ЗначенияФильтра_ПравилаОбмена(ЭлементДанных, ПараметрыЗапроса);
	ИначеЕсли ТипЗначенияОбъекта = Тип("СправочникОбъект.ПравилаКонвертацииСвойств") Тогда
		ЗначенияФильтра_ПравилаОбмена(ЭлементДанных.Владелец, ПараметрыЗапроса); 
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("СправочникОбъект.СоставыКонвертаций") Тогда
		...
		ПараметрыЗапроса.Конвертации = МассивКонвертаций
	ИначеЕсли ТипЗначенияОбъекта = Тип("СправочникОбъект.Релизы") Тогда
	...
	ИначеЕсли ТипЗначенияОбъекта = Тип("СправочникОбъект.Регистрации") Тогда
		ЗначенияФильтра_Конфигурации(ЭлементДанных.Конфигурация, ПараметрыЗапроса);
	ИначеЕсли ТипЗначенияОбъекта = Тип("СправочникОбъект.ПравилаРегистрацииОбъектов") Тогда
		ЗначенияФильтра_Конфигурации(ЭлементДанных.Владелец.Конфигурация, ПараметрыЗапроса);
	Иначе
